...
library(tidyr)
library(stargazer)
setwd("C:/R_Git/gvpt849_git/exam")
data <- read.csv("descriptive_threeDatasets.csv", sep = ",",header = T)
save(data, file = "data.RData")
load("data.RData")
stargazer(data,type = 'text')
```
To answer this question I pulled the descriptive statistics for each dataset (`BC`, `MC`, `voter`) and collected the number of people that voted in each party, the party means, and the party standard deviations.  I also collected the mean, standard deviation, minimum, and maximum values of the voters from each of the three datasets.

First, I put all of the data together, grouping it by dataset.  The results are depicted in Table 3.  Montgomery voters
