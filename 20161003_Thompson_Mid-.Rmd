...
To answer this question I followed these steps:
  ...
  * imported table:  `tl_2012_us_cd112.shp` (congressional districts)
  
  * used the Merge tool from ArcToolbox->Data Management Tools->General->Merge to create a new layer called `combined_pointFiles`
